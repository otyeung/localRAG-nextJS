...
export function MessageComposer({
  ...
  return (
    <div className="rounded-[1.75rem] border border-[color:var(--border-soft)] bg-[color:var(--panel-elevated)] p-3 shadow-[var(--shadow-panel)]">
      ...
      <textarea
        ...
        className="min-h-28 w-full resize-none bg-transparent px-3 py-2 text-sm leading-7 text-[color:var(--text-strong)] outline-none placeholder:text-[color:var(--text-dim)]"
      />
      <div className="mt-3 flex flex-wrap items-center justify-between gap-3 border-t border-[color:var(--border-soft)] px-2 pt-3">

...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      process.env.LOCALRAG_LIVE_CORPUS_TESTS !== '1'
      ...
      ANONYMOUS_COOKIE_SECRET:
        process.env.ANONYMOUS_COOKIE_SECRET ??
        'playwright-anonymous-cookie-secret',
      TEMP_UPLOAD_DIRECTORY:
        process.env.TEMP_UPLOAD_DIRECTORY ?? '.playwright/uploads',
    },
  },
  use: {
